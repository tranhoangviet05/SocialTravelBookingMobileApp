        ...
        <div className="space-y-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        <select
                            ...
                            className="px-4 py-2.5 bg-white border border-gray-100 rounded-2xl text-xs font-bold text-slate-600 focus:outline-none cursor-pointer"
                        >
            ...
            {resolveModal.open && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    <div className="absolute inset-0 bg-slate-900/60 backdrop-blur-sm" onClick={() => setResolveModal({ open: false, report: null })} />
            ...
            {detailModal.open && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    <div className="absolute inset-0 bg-slate-900/60 backdrop-blur-sm" onClick={() => setDetailModal({ open: false, report: null, loading: false })} />
